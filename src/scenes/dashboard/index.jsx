  ...
  return (
    ...
    <Box m="20px">
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center">
        ...
        <Box>
          {/* Your header-related content can go here */}
        </Box>
      </Box>
      ...
      >
        ...
        >
          <StatBox
            ...
            subtitle="Monthly"
            icon={
              <CalendarMonthOutlinedIcon sx={{ color: colors.greenAccent[600], fontSize: "26px" }} />
            }
          />
        </Box>
        ...
        <Box gridColumn="span 4" gridRow="span 2" backgroundColor={colors.primary[400]} color={colors.grey[100]}>
          <Box mt="20px" p="0 25px" display="flex" justifyContent="space-between" alignItems="center">
            <Box>
              <Typography variant="h5" fontWeight="600" color={colors.grey[100]}  >
                Weekly and Monthly
              </Typography>
